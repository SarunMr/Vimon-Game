...
public class MenuPage extends javax.swing.JFrame {
    ...
    getContentPane().add(gametTitleImage, new org.netbeans.lib.awtextra.AbsoluteConstraints(-10, -30, -1, -1));
    ...
    this.dispose(); // Replace the close() method with dispose()
    ...
    // Fix the class name and variable name consistency
    VimanEasy vimanGame = new VimanEasy();
    frame.add(vimanGame);
    frame.pack();
    vimanGame.requestFocus();
